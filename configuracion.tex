...
\EPSsetup{
  ...
  titulo = {Herramienta para la generación automática de exámenes},

  % Subtítulo (opcional, se muestra en portada B/N)
  % Nota: el template requiere un valor no vacío; usar ~ para "sin subtítulo".
  subtitulo = {~},
  ...
  tutor = {Dr. Fidel Aznar Gregori},
  tutor-genero = m,  % m = masculino, f = femenino, n = neutro
  tutor-departamento = {Departamento de Ciencia de la Computación e Inteligencia Artificial},
