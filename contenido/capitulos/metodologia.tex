...
Haiku 4.5 como modelo generador por defecto de la herramienta, por su
coste y rapidez, y Claude Sonnet 4.6, más capaz, en el papel de juez en
la evaluación (capítulo~\ref{cap:resultados}). La
...
dicho agente, con el fin de determinar en qué medida la revisión
automática mejora la calidad de las preguntas respecto a una generación
sin postprocesado. Su diseño concreto ---corpus, procedimiento, criterio
de evaluación y métricas--- se detalla en el capítulo de desarrollo
(sección~\ref{sec:diseno-ablacion}), donde encaja junto a la construcción
del sistema sobre el que se realiza.